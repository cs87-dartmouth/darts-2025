...
public:
    ...
    */
    virtual Color3f eval(const Ray3f &ray, const Vec3f &scattered, const HitRecord &hit) const { return Color3f(0.0f); }
    ...
    */
    virtual float pdf(const Ray3f &ray, const Vec3f &scattered, const HitRecord &hit) const { return 0.0f; }
};
