...
public:
    ...
    static int axis(const Data &data) { return data.axis(); }

    /// Set the axis of the node
    static void set_axis(Data &data, int axis) { return data.set_axis(axis); }
};
